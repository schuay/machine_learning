...
Preprocessing   & Beneficial   & Optional       & TODO           & TODO              \\
...
% TODO: Describe benching machine specs.
...
and are labelled with a \texttt{\_aes\_id} suffix. % TODO: Correctly relabel in files.
The accuracy of
...
by properties of the dataset. According to the literature\footnote{A. Go, R. Bhayani, and L. Huang.
...
USA, 2012. ACM.}, 80\% accuracy compares favorably to best result achieved by others within the same area.
This demonstrates that good results may be achieved by very simple means, in this case the SVM classifier
provided by \texttt{scikit-learn} and basic preprocessing.
...
Classifier & Train. Time (s) & Eval. Time (s) & Accuracy \\
\midrule
Bayes (\ratiostd) & 0.0077 & 0.026 & 0.95 \\ % TODO: Fill in correct data.
SVM (\ratiostd)   & 0.0224 & 0.024 & 1.0  \\
Bayes (\tenfold)  & 0.0091 & 0.011 & 0.96 \\
SVM (\tenfold)    & 0.0263 & 0.01  & 1.0  \\
\bottomrule
