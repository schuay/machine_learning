...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\annealing: Main results}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\annealing: Accuracy and runtime}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\twitter: Main results}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\twitter: Accuracy and runtime}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\powerconsumption}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\powerconsumption: Main results}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\powerconsumption: Mean squared error, $R^2$ score and runtime}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\powerconsumption: Mean squared error}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\powerconsumption: $R^2$ score}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\powerconsumption: Regressor Size}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\housing: Main results}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\housing: Mean squared error, $R^2$ score and runtime}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\housing: Mean squared error}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\housing: $R^2$ score}
...
\begin{frame}{\nameref{sec:results}}
\framesubtitle{\housing: Regressor Size}
