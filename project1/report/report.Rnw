...
The Figures~\ref{fig:annealing} through \ref{fig:randomten} show the results of our
ensemble classifiers for each of our ten datasets. In a) through f) the mean accuracies
...
plot_accuracy(c("../results/random10.csv", "../results/vowel.scale.csv", "../results/heart_scale.csv",
		...
		c("mix_default_simple_ensemble", "nb7_simple_ensemble", "knn7_simple_ensemble",
			...
			"extraforest2_weighted_ensemble", "extraforest2_simple_ensemble",
			"nbsmall_simple_ensemble", "nbsmall_weighted_ensemble",
			"svmsmall_simple_ensemble", "svmsmall_weighted_ensemble",
			"knnsmall_simple_ensemble", "knnsmall_weighted_ensemble",
			"treesmall_simple_ensemble", "treesmall_weighted_ensemble"))
@
\caption{\randomten, \vowel, \heart, \digits}
\end{figure}
...
plot_accuracy(c("../results/random10.csv", "../results/vowel.scale.csv", "../results/heart_scale.csv",
		...
		c("mix_default_simple_ensemble", "mix_default_weighted_ensemble", "nb0", "knn0", "svm0", "tree0", "extratree0"))
@
\caption{\randomten, \vowel, \heart, \digits-mix\_default}
\end{figure}
...
@
\caption{\randomten, \vowel, \heart, \digits-treesmall}
\end{figure}
